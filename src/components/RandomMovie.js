    ...
    ? <div className='loading-random'><img src={loadingWheel} alt="Loading Wheel"/></div>
      ...
      <div className="random-movie-text">
        ...
        { randomMovie.overview
          ? <p className='random-movie-details'><span className="text-bold">Synopsis</span>: {randomMovie.overview}</p>
          : <p className='random-movie-details'><span className="text-bold">Synopsis</span>: No sinopsis available</p>}
